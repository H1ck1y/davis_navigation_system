...
TEST(KMLWriterTest, DISABLED_SimpleTest){
...
TEST(KMLWriterTest, DISABLED_PointStyleTest){
    auto OutStream = std::make_shared<CStringDataSink>();
    {
...
TEST(KMLWriterTest,DISABLED_LineStyleTest){
    auto OutStream = std::make_shared<CStringDataSink>();
    {
...
TEST(KMLWriterTest, DISABLED_PointTest){
    auto OutStream = std::make_shared<CStringDataSink>();
    {
...
TEST(KMLWriterTest, DISABLED_PathTest){
    auto OutStream = std::make_shared<CStringDataSink>();
    {
